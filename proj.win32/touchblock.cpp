    ...
    int       nCmdShow)
{
    ...
    return TouchblockPlayer::createAndRun();
}

int TouchblockPlayer::createAndRun(void)
{
    TouchblockPlayer *host = TouchblockPlayer::sharedInstance();
    int ret = host->run();
    TouchblockPlayer::purgeSharedInstance();
    return ret;
}

TouchblockPlayer *TouchblockPlayer::s_sharedInstance = NULL;

TouchblockPlayer *TouchblockPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new TouchblockPlayer();
    }
    return s_sharedInstance;
}

void TouchblockPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
TouchblockPlayer::TouchblockPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int TouchblockPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "touchblock-player");
...
void TouchblockPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void TouchblockPlayer::createViewMenu(void)
{
...
void TouchblockPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void TouchblockPlayer::updateWindowTitle(void)
{
}

void TouchblockPlayer::relaunch(void)
{
...
void TouchblockPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void TouchblockPlayer::onFileOpenProject(void)
{
...
void TouchblockPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"TouchblockPlayer");
...
void TouchblockPlayer::onFileProjectConfig(void)
{
...
void TouchblockPlayer::onFileRelaunch(void)
{
    relaunch();
}

void TouchblockPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void TouchblockPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void TouchblockPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void TouchblockPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void TouchblockPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT TouchblockPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    TouchblockPlayer *host = TouchblockPlayer::sharedInstance();
...
INT_PTR CALLBACK TouchblockPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
